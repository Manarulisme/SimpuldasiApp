            ...
            <div class="topbar-left">
                ...
                <div>
                    ...
                    <p class="page-subtitle">
                        Kesejahteraan Sosial · Data Stunting
                    </p>
        ...
        <div class="content">
            ...
            <div class="content-header">
                ...
                <div>
                    ...
                    <p>
                        Kelola data anak stunting Kelurahan XXXXX
                        Kelurahan XXXXX.
                    </p>
    ...
    <div class="modal">
        ...
        <div class="modal-body">
            <form id="formEditDUK">
                <div class="form-grid">
                    <div class="form-group">
                        <label class="form-label" for="editJenis">Jenis</label>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="editGolongan">RW</label>
                        <input type="text" class="form-control" id="editGolongan" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="editPangkat">Usia Bulan</label>
                        <input type="text" class="form-control" id="editPangkat" required>
                    </div>

                    <div class="form-group full">
                        <label class="form-label" for="editJabatan">Status</label>
...
<script>
    ...
    function viewData(button) {
        ...
        alert(
            ...
            "Usia Bulan: " + cells[3].innerText.trim() + "\n" +
    ...
    function editData(button) {
        ...
        document.getElementById("editPangkat").value = cells[3].innerText.trim();
        document.getElementById("editJabatan").value = cells[4].innerText.trim();
        document.getElementById("editKeterangan").value = cells[5].innerText.trim();
    ...
    btnEditSimpan.addEventListener(
        ...
        function() {
            ...
            cells[3].innerText = document.getElementById("editPangkat").value;
            cells[4].innerText = document.getElementById("editJabatan").value;
            cells[5].innerText = document.getElementById("editKeterangan").value;
