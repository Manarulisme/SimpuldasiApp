...
<head>
    ...
    <title>Edit Data Anak Putus Sekolah - Kelurahan XXXXX</title>
    ...
    <main class="main">
        ...
        <header class="topbar">
            ...
            <div class="page-heading">
                <h1>Edit Data Anak Putus Sekolah</h1>
                <p>Kesejahteraan Sosial · Anak Putus Sekolah · Edit Data</p>
            </div>
        ...
        <section class="content">
            ...
            <div class="page-title">
                <h2>Edit Data Anak Putus Sekolah</h2>
                <p>Perbarui data anak putus sekolah Kelurahan XXXXX.</p>
            </div>
