...
<head>
    ...
    <title>Edit Data Sekolah - Kelurahan XXXXX</title>
    ...
    <main class="main">
        ...
        <header class="topbar">
            ...
            <div class="page-heading">
                ...
                <p>Kesejahteraan Sosial · Data Sekolah · Edit Data</p>
            </div>
        ...
        <section class="content">
            ...
            <div class="page-title">
                ...
                <p>Perbarui data sekolah Kelurahan XXXXX.</p>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="form-header">
                    ...
                    <p>Perbarui informasi sekolah pada kolom yang tersedia.</p>
                </div>
                ...
                <form id="sekolahForm" method="POST" action="{{ url()->current() }}">
                    ...
                    <div class="form-body">
                        ...
                        <div class="info-box">
                            ...
                            <p>
                                Periksa kembali perubahan data sekolah sebelum menyimpan.
                            </p>
