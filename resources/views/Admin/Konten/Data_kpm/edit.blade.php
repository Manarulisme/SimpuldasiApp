...
<head>
    ...
    <title>Edit Data KPM / Bantuan Sosial - Kelurahan XXXXX</title>
    ...
    <main class="main">
        ...
        <header class="topbar">
            ...
            <div class="page-heading">
                <h1>Edit Data KPM / Bantuan Sosial</h1>
                <p>Kesejahteraan Sosial · KPM / Bantuan Sosial · Edit Data</p>
            </div>
        ...
        <section class="content">
            ...
            <div class="page-title">
                <h2>Edit Data KPM / Bantuan Sosial</h2>
                <p>Perbarui data penerima bantuan sosial Kelurahan XXXXX.</p>
            </div>
            ...
            <div class="form-card">
                ...
                <div class="form-header">
                    ...
                    <p>Perbarui informasi penerima bantuan pada kolom yang tersedia.</p>
                </div>
                ...
                <form id="kpmForm" method="POST" action="{{ url()->current() }}">
                    ...
                    <div class="form-body">
                        ...
                        <div class="info-box">
                            ...
                            <p>
                                Periksa kembali perubahan data KPM sebelum menyimpan.
                            </p>
