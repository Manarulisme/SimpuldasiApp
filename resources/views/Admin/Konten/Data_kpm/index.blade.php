...
>
    ...
    <div class="modal">
        ...
        <div class="modal-header">
            ...
            <h3>
                Tambah Data KPM / Bantuan Sosial
            </h3>
...
<div class="modal-overlay" id="modalEditOverlay">
    <div class="modal">
        <div class="modal-header">
            <h3>Edit Data KPM / Bantuan Sosial</h3>
        ...
        <div class="modal-body">
            <form id="formEditDUK">
                <div class="form-grid">
                    <div class="form-group">
                        <label class="form-label" for="editJenis">Jenis Bantuan</label>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="editNomor">NIK</label>
                        <input type="text" class="form-control" id="editNomor" required>
                    </div>

                    <div class="form-group full">
                        <label class="form-label" for="editNama">Nama KPM</label>
                        <input type="text" class="form-control" id="editNama" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="editGolongan">Alamat RW</label>
                        <input type="text" class="form-control" id="editGolongan" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="editPangkat">Desil</label>
...
<script>
    ...
    function editData(button) {
        ...
        document.getElementById("editNomor").value = cells[1].innerText.trim();
        document.getElementById("editGolongan").value = cells[2].innerText.trim();
        document.getElementById("editJenis").value = cells[3].innerText.trim();
    ...
    btnEditSimpan.addEventListener(
        ...
        function() {
            ...
            alert(
                ...
                "Nama KPM: " + document.getElementById("editNama").value
            );

            const cells = selectedEditRow.cells;

            cells[0].innerText = document.getElementById("editNama").value;
            cells[1].innerText = document.getElementById("editNomor").value;
            cells[2].innerText = document.getElementById("editGolongan").value;
            cells[3].innerText = document.getElementById("editJenis").value;
